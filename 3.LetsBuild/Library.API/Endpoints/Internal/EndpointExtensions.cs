...
public static class EndpointExtensions
{
    ...
    public static void UserEndpoints<TMarker>(this IApplicationBuilder app)
    {
        UserEndpoints(app, typeof(TMarker));
    }
    private static void UserEndpoints(this IApplicationBuilder app, Type typeMarker)
    {
        var endpointTypes = GetEndpointTypesFromAssemblyContaining(typeMarker);
        foreach (var endpointType in endpointTypes)
        {
